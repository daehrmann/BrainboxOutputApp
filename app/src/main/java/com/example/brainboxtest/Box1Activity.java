...
public class Box1Activity extends AppCompatActivity {
    ...
    public void buttonOnClickListeners() {
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(Box1Activity.this, MainActivity.class));
            }
        });
    ...
    public void InitializeUI() {
        ...
        outButtons.add((Button) findViewById(R.id.bb1b1));
        outButtons.add((Button) findViewById(R.id.bb1b2));
        outButtons.add((Button) findViewById(R.id.bb1b3));
        outButtons.add((Button) findViewById(R.id.bb1b4));
        outButtons.add((Button) findViewById(R.id.bb1b5));
        outButtons.add((Button) findViewById(R.id.bb1b6));
        outButtons.add((Button) findViewById(R.id.bb1b7));
        outButtons.add((Button) findViewById(R.id.bb1b8));
        outButtons.add((Button) findViewById(R.id.bb1b9));
        outButtons.add((Button) findViewById(R.id.bb1b10));
        outButtons.add((Button) findViewById(R.id.bb1b11));
        outButtons.add((Button) findViewById(R.id.bb1b12));
        outButtons.add((Button) findViewById(R.id.bb1b13));
        outButtons.add((Button) findViewById(R.id.bb1b14));
        outButtons.add((Button) findViewById(R.id.bb1b15));
        outButtons.add((Button) findViewById(R.id.bb1b16));
        for(int j = 0; j < 16; j++)
        {
            tapCounters.add(0);
        }
    ...
    {
        //connections
        IConnection tcpConnection1 = new TCPConnection("10.0.0.4", 9500);
