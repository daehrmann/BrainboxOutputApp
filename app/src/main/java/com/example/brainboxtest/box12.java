...
public class box12 extends AppCompatActivity {
    ...
    final int brainBoxNum = 11;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_box12);
    ...
    public void buttonOnClickListeners() {
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(box12.this, MainActivity.class));
            }
        });
    ...
    public void InitializeUI() {
        ...
        outButtons.add((Button) findViewById(R.id.bb12b1));
        outButtons.add((Button) findViewById(R.id.bb12b2));
        outButtons.add((Button) findViewById(R.id.bb12b3));
        outButtons.add((Button) findViewById(R.id.bb12b4));
        outButtons.add((Button) findViewById(R.id.bb12b5));
        outButtons.add((Button) findViewById(R.id.bb12b6));
        outButtons.add((Button) findViewById(R.id.bb12b7));
        outButtons.add((Button) findViewById(R.id.bb12b8));
        outButtons.add((Button) findViewById(R.id.bb12b9));
        outButtons.add((Button) findViewById(R.id.bb12b10));
        outButtons.add((Button) findViewById(R.id.bb12b11));
        outButtons.add((Button) findViewById(R.id.bb12b12));
        outButtons.add((Button) findViewById(R.id.bb12b13));
        outButtons.add((Button) findViewById(R.id.bb12b14));
        outButtons.add((Button) findViewById(R.id.bb12b15));
        outButtons.add((Button) findViewById(R.id.bb12b16));
        for(int j = 0; j < 16; j++)
        {
            tapCounters.add(0);
        }
    ...
    {
        //connections
        IConnection tcpConnection1 = new TCPConnection("10.0.0.15", 9500);
