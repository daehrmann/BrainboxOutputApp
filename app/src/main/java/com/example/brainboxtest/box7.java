...
public class box7 extends AppCompatActivity {
    ...
    final int brainBoxNum = 6;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_box7);
    ...
    public void buttonOnClickListeners() {
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(box7.this, MainActivity.class));
            }
        });
    ...
    public void InitializeUI() {
        ...
        outButtons.add((Button) findViewById(R.id.bb7b1));
        outButtons.add((Button) findViewById(R.id.bb7b2));
        outButtons.add((Button) findViewById(R.id.bb7b3));
        outButtons.add((Button) findViewById(R.id.bb7b4));
        outButtons.add((Button) findViewById(R.id.bb7b5));
        outButtons.add((Button) findViewById(R.id.bb7b6));
        outButtons.add((Button) findViewById(R.id.bb7b7));
        outButtons.add((Button) findViewById(R.id.bb7b8));
        outButtons.add((Button) findViewById(R.id.bb7b9));
        outButtons.add((Button) findViewById(R.id.bb7b10));
        outButtons.add((Button) findViewById(R.id.bb7b11));
        outButtons.add((Button) findViewById(R.id.bb7b12));
        outButtons.add((Button) findViewById(R.id.bb7b13));
        outButtons.add((Button) findViewById(R.id.bb7b14));
        outButtons.add((Button) findViewById(R.id.bb7b15));
        outButtons.add((Button) findViewById(R.id.bb7b16));
        for(int j = 0; j < 16; j++)
        {
            tapCounters.add(0);
        }
    ...
    {
        //connections
        IConnection tcpConnection1 = new TCPConnection("10.0.0.10", 9500);
