...
public class box3 extends AppCompatActivity {
    ...
    public void buttonOnClickListeners() {
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(box3.this, MainActivity.class));
            }
        });
    ...
    public void InitializeUI() {
        ...
        outButtons.add((Button) findViewById(R.id.bb3b1));
        outButtons.add((Button) findViewById(R.id.bb3b2));
        outButtons.add((Button) findViewById(R.id.bb3b3));
        outButtons.add((Button) findViewById(R.id.bb3b4));
        outButtons.add((Button) findViewById(R.id.bb3b5));
        outButtons.add((Button) findViewById(R.id.bb3b6));
        outButtons.add((Button) findViewById(R.id.bb3b7));
        outButtons.add((Button) findViewById(R.id.bb3b8));
        outButtons.add((Button) findViewById(R.id.bb3b9));
        outButtons.add((Button) findViewById(R.id.bb3b10));
        outButtons.add((Button) findViewById(R.id.bb3b11));
        outButtons.add((Button) findViewById(R.id.bb3b12));
        outButtons.add((Button) findViewById(R.id.bb3b13));
        outButtons.add((Button) findViewById(R.id.bb3b14));
        outButtons.add((Button) findViewById(R.id.bb3b15));
        outButtons.add((Button) findViewById(R.id.bb3b16));
        for(int j = 0; j < 16; j++)
        {
            tapCounters.add(0);
        }
    ...
    {
        //connections
        IConnection tcpConnection1 = new TCPConnection("10.0.0.6", 9500);
