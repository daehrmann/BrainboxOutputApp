...
public class box11 extends AppCompatActivity {
    ...
    final int brainBoxNum = 10;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_box11);
    ...
    public void buttonOnClickListeners() {
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(box11.this, MainActivity.class));
            }
        });
    ...
    public void InitializeUI() {
        ...
        outButtons.add((Button) findViewById(R.id.bb11b1));
        outButtons.add((Button) findViewById(R.id.bb11b2));
        outButtons.add((Button) findViewById(R.id.bb11b3));
        outButtons.add((Button) findViewById(R.id.bb11b4));
        outButtons.add((Button) findViewById(R.id.bb11b5));
        outButtons.add((Button) findViewById(R.id.bb11b6));
        outButtons.add((Button) findViewById(R.id.bb11b7));
        outButtons.add((Button) findViewById(R.id.bb11b8));
        outButtons.add((Button) findViewById(R.id.bb11b9));
        outButtons.add((Button) findViewById(R.id.bb11b10));
        outButtons.add((Button) findViewById(R.id.bb11b11));
        outButtons.add((Button) findViewById(R.id.bb11b12));
        outButtons.add((Button) findViewById(R.id.bb11b13));
        outButtons.add((Button) findViewById(R.id.bb11b14));
        outButtons.add((Button) findViewById(R.id.bb11b15));
        outButtons.add((Button) findViewById(R.id.bb11b16));
        for(int j = 0; j < 16; j++)
        {
            tapCounters.add(0);
        }
    ...
    {
        //connections
        IConnection tcpConnection1 = new TCPConnection("10.0.0.14", 9500);
