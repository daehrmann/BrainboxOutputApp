...
public class box10 extends AppCompatActivity {
    ...
    final int brainBoxNum = 9;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_box10);
    ...
    public void buttonOnClickListeners() {
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(box10.this, MainActivity.class));
            }
        });
    ...
    public void InitializeUI() {
        ...
        outButtons.add((Button) findViewById(R.id.bb10b1));
        outButtons.add((Button) findViewById(R.id.bb10b2));
        outButtons.add((Button) findViewById(R.id.bb10b3));
        outButtons.add((Button) findViewById(R.id.bb10b4));
        outButtons.add((Button) findViewById(R.id.bb10b5));
        outButtons.add((Button) findViewById(R.id.bb10b6));
        outButtons.add((Button) findViewById(R.id.bb10b7));
        outButtons.add((Button) findViewById(R.id.bb10b8));
        outButtons.add((Button) findViewById(R.id.bb10b9));
        outButtons.add((Button) findViewById(R.id.bb10b10));
        outButtons.add((Button) findViewById(R.id.bb10b11));
        outButtons.add((Button) findViewById(R.id.bb10b12));
        outButtons.add((Button) findViewById(R.id.bb10b13));
        outButtons.add((Button) findViewById(R.id.bb10b14));
        outButtons.add((Button) findViewById(R.id.bb10b15));
        outButtons.add((Button) findViewById(R.id.bb10b16));
        for(int j = 0; j < 16; j++)
        {
            tapCounters.add(0);
        }
    ...
    {
        //connections
        IConnection tcpConnection1 = new TCPConnection("10.0.0.13", 9500);
