...
public class box8 extends AppCompatActivity {
    ...
    final int brainBoxNum = 7;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_box8);
    ...
    public void buttonOnClickListeners() {
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(box8.this, MainActivity.class));
            }
        });
    ...
    public void InitializeUI() {
        ...
        outButtons.add((Button) findViewById(R.id.bb8b1));
        outButtons.add((Button) findViewById(R.id.bb8b2));
        outButtons.add((Button) findViewById(R.id.bb8b3));
        outButtons.add((Button) findViewById(R.id.bb8b4));
        outButtons.add((Button) findViewById(R.id.bb8b5));
        outButtons.add((Button) findViewById(R.id.bb8b6));
        outButtons.add((Button) findViewById(R.id.bb8b7));
        outButtons.add((Button) findViewById(R.id.bb8b8));
        outButtons.add((Button) findViewById(R.id.bb8b9));
        outButtons.add((Button) findViewById(R.id.bb8b10));
        outButtons.add((Button) findViewById(R.id.bb8b11));
        outButtons.add((Button) findViewById(R.id.bb8b12));
        outButtons.add((Button) findViewById(R.id.bb8b13));
        outButtons.add((Button) findViewById(R.id.bb8b14));
        outButtons.add((Button) findViewById(R.id.bb8b15));
        outButtons.add((Button) findViewById(R.id.bb8b16));
        for(int j = 0; j < 16; j++)
        {
            tapCounters.add(0);
        }
    ...
    {
        //connections
        IConnection tcpConnection1 = new TCPConnection("10.0.0.11", 9500);
