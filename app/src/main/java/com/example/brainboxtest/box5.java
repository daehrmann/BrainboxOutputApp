...
public class box5 extends AppCompatActivity {
    ...
    public void buttonOnClickListeners() {
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(box5.this, MainActivity.class));
            }
        });
    ...
    public void InitializeUI() {
        ...
        outButtons.add((Button) findViewById(R.id.bb5b1));
        outButtons.add((Button) findViewById(R.id.bb5b2));
        outButtons.add((Button) findViewById(R.id.bb5b3));
        outButtons.add((Button) findViewById(R.id.bb5b4));
        outButtons.add((Button) findViewById(R.id.bb5b5));
        outButtons.add((Button) findViewById(R.id.bb5b6));
        outButtons.add((Button) findViewById(R.id.bb5b7));
        outButtons.add((Button) findViewById(R.id.bb5b8));
        outButtons.add((Button) findViewById(R.id.bb5b9));
        outButtons.add((Button) findViewById(R.id.bb5b10));
        outButtons.add((Button) findViewById(R.id.bb5b11));
        outButtons.add((Button) findViewById(R.id.bb5b12));
        outButtons.add((Button) findViewById(R.id.bb5b13));
        outButtons.add((Button) findViewById(R.id.bb5b14));
        outButtons.add((Button) findViewById(R.id.bb5b15));
        outButtons.add((Button) findViewById(R.id.bb5b16));
        for(int j = 0; j < 16; j++)
        {
            tapCounters.add(0);
        }
    ...
    {
        //connections
        IConnection tcpConnection1 = new TCPConnection("10.0.0.8", 9500);
