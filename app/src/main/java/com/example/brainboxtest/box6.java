...
public class box6 extends AppCompatActivity {
    ...
    final int brainBoxNum = 5;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_box6);
    ...
    public void buttonOnClickListeners() {
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(box6.this, MainActivity.class));
            }
        });
    ...
    public void InitializeUI() {
        ...
        outButtons.add((Button) findViewById(R.id.bb6b1));
        outButtons.add((Button) findViewById(R.id.bb6b2));
        outButtons.add((Button) findViewById(R.id.bb6b3));
        outButtons.add((Button) findViewById(R.id.bb6b4));
        outButtons.add((Button) findViewById(R.id.bb6b5));
        outButtons.add((Button) findViewById(R.id.bb6b6));
        outButtons.add((Button) findViewById(R.id.bb6b7));
        outButtons.add((Button) findViewById(R.id.bb6b8));
        outButtons.add((Button) findViewById(R.id.bb6b9));
        outButtons.add((Button) findViewById(R.id.bb6b10));
        outButtons.add((Button) findViewById(R.id.bb6b11));
        outButtons.add((Button) findViewById(R.id.bb6b12));
        outButtons.add((Button) findViewById(R.id.bb6b13));
        outButtons.add((Button) findViewById(R.id.bb6b14));
        outButtons.add((Button) findViewById(R.id.bb6b15));
        outButtons.add((Button) findViewById(R.id.bb6b16));
        for(int j = 0; j < 16; j++)
        {
            tapCounters.add(0);
        }
    ...
    {
        //connections
        IConnection tcpConnection1 = new TCPConnection("10.0.0.9", 9500);
