...
public class box4 extends AppCompatActivity {
    ...
    final int brainBoxNum = 3;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_box4);
    ...
    public void buttonOnClickListeners() {
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(box4.this, MainActivity.class));
            }
        });
    ...
    public void InitializeUI() {
        ...
        outButtons.add((Button) findViewById(R.id.bb4b1));
        outButtons.add((Button) findViewById(R.id.bb4b2));
        outButtons.add((Button) findViewById(R.id.bb4b3));
        outButtons.add((Button) findViewById(R.id.bb4b4));
        outButtons.add((Button) findViewById(R.id.bb4b5));
        outButtons.add((Button) findViewById(R.id.bb4b6));
        outButtons.add((Button) findViewById(R.id.bb4b7));
        outButtons.add((Button) findViewById(R.id.bb4b8));
        outButtons.add((Button) findViewById(R.id.bb4b9));
        outButtons.add((Button) findViewById(R.id.bb4b10));
        outButtons.add((Button) findViewById(R.id.bb4b11));
        outButtons.add((Button) findViewById(R.id.bb4b12));
        outButtons.add((Button) findViewById(R.id.bb4b13));
        outButtons.add((Button) findViewById(R.id.bb4b14));
        outButtons.add((Button) findViewById(R.id.bb4b15));
        outButtons.add((Button) findViewById(R.id.bb4b16));
        for(int j = 0; j < 16; j++)
        {
            tapCounters.add(0);
        }
    ...
    {
        //connections
        IConnection tcpConnection1 = new TCPConnection("10.0.0.7", 9500);
