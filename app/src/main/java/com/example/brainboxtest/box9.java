...
public class box9 extends AppCompatActivity {
    ...
    final int brainBoxNum = 8;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_box9);
    ...
    public void buttonOnClickListeners() {
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(box9.this, MainActivity.class));
            }
        });
    ...
    public void InitializeUI() {
        ...
        outButtons.add((Button) findViewById(R.id.bb9b1));
        outButtons.add((Button) findViewById(R.id.bb9b2));
        outButtons.add((Button) findViewById(R.id.bb9b3));
        outButtons.add((Button) findViewById(R.id.bb9b4));
        outButtons.add((Button) findViewById(R.id.bb9b5));
        outButtons.add((Button) findViewById(R.id.bb9b6));
        outButtons.add((Button) findViewById(R.id.bb9b7));
        outButtons.add((Button) findViewById(R.id.bb9b8));
        outButtons.add((Button) findViewById(R.id.bb9b9));
        outButtons.add((Button) findViewById(R.id.bb9b10));
        outButtons.add((Button) findViewById(R.id.bb9b11));
        outButtons.add((Button) findViewById(R.id.bb9b12));
        outButtons.add((Button) findViewById(R.id.bb9b13));
        outButtons.add((Button) findViewById(R.id.bb9b14));
        outButtons.add((Button) findViewById(R.id.bb9b15));
        outButtons.add((Button) findViewById(R.id.bb9b16));
        for(int j = 0; j < 16; j++)
        {
            tapCounters.add(0);
        }
    ...
    {
        //connections
        IConnection tcpConnection1 = new TCPConnection("10.0.0.12", 9500);
